...
""));
        ...
        bypass = new QPushButton(Authentification);
        bypass->setObjectName("bypass");
        bypass->setGeometry(QRect(390, 470, 90, 29));
        label->raise();
        label_3->raise();
        lineEdit->raise();
    ...
    void retranslateUi(QDialog *Authentification)
    {
        ...
        bypass->setText(QCoreApplication::translate("Authentification", "bypass", nullptr));
    } // retranslateUi
