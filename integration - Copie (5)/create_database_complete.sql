...
-- =====================================================
CREATE TABLE HIBA.GEST_RESIDENT (
...
-- =====================================================
CREATE TABLE HIBA.GEST_VEHICULE (
    ...
    CONSTRAINT FK_VEHICULE_RESIDENT FOREIGN KEY (ID_RESIDENT) 
        REFERENCES HIBA.GEST_RESIDENT(ID) ON DELETE CASCADE
);

-- TABLE : GEST_EMPLOYE (Employés)
-- =====================================================
CREATE TABLE HIBA.GEST_EMPLOYE (
    ID NUMBER(10) PRIMARY KEY,
    NOM VARCHAR2(50 BYTE) NOT NULL,
    PRENOM VARCHAR2(50 BYTE) NOT NULL,
    ...
    CONSTRAINT FK_EMPLOYE_RESIDENT FOREIGN KEY (ID_RESIDENT) 
        REFERENCES HIBA.GEST_RESIDENT(ID) ON DELETE SET NULL
);

-- TABLE : GEST_CABINET (Cabinets)
-- =====================================================
CREATE TABLE HIBA.GEST_CABINET (
    ID NUMBER(10) PRIMARY KEY,
    NOM VARCHAR2(50 BYTE) NOT NULL,
...
-- =====================================================
CREATE TABLE HIBA.GEST_RESIDENT_JARDIN (
    ID_RESIDENT NUMBER(10),
    ID_JARDIN NUMBER,
    DATE_ACCES DATE,
    ...
    CONSTRAINT FK_RJ_JARDIN FOREIGN KEY (ID_JARDIN) 
        REFERENCES HIBA.GEST_JARDIN(ID_JARDIN) ON DELETE CASCADE
);

-- TABLE : GEST_RESIDENT_MAISON (Relation Résident-Maison)
-- =====================================================
CREATE TABLE HIBA.GEST_RESIDENT_MAISON (
    ID_RESIDENT NUMBER(10),
    ID_MAISON NUMBER,
    ...
    CONSTRAINT FK_RM_MAISON FOREIGN KEY (ID_MAISON) 
        REFERENCES HIBA.GEST_MAISON(ID_MAISON) ON DELETE CASCADE
);
...
-- =====================================================
CREATE TABLE HIBA.HIST_RESIDENT (
...
CREATE OR REPLACE TRIGGER HIBA.TRG_HIST_RESIDENT_ID
    BEFORE INSERT ON HIBA.HIST_RESIDENT
    FOR EACH ROW
BEGIN
    IF :NEW.ID_HISTORIQUE IS NULL THEN
        SELECT HIBA.HISTORIQUE_RESIDENT_SEQ.NEXTVAL INTO :NEW.ID_HISTORIQUE FROM DUAL;
...
BEGIN
    ...
    INSERT INTO HIBA.HIST_RESIDENT (ID_RESIDENT, ACTION, DATE_ACTION)
    VALUES (:NEW.ID, 'Ajout', SYSDATE);
END;
/
...
CREATE INDEX HIBA.IDX_VEHICULE_RESIDENT ON HIBA.GEST_VEHICULE(ID_RESIDENT);
CREATE INDEX HIBA.IDX_EMPLOYE_RESIDENT ON HIBA.GEST_EMPLOYE(ID_RESIDENT);
CREATE INDEX HIBA.IDX_CABINET_RESIDENT ON HIBA.GEST_CABINET(ID_RESIDENT);

-- Index sur les colonnes de recherche fréquente
CREATE INDEX HIBA.IDX_RESIDENT_NOM ON HIBA.GEST_RESIDENT(NOM);
CREATE INDEX HIBA.IDX_RESIDENT_EMAIL ON HIBA.GEST_RESIDENT(EMAIL);
CREATE INDEX HIBA.IDX_RESIDENT_TELEPHONE ON HIBA.GEST_RESIDENT(TELEPHONE);
...
CREATE INDEX HIBA.IDX_HIST_ACTION ON HIBA.HISTORIQUE_RESIDENT(ACTION);

CREATE INDEX HIBA.IDX_HIST2_RESIDENT_ID ON HIBA.HIST_RESIDENT(ID_RESIDENT);
CREATE INDEX HIBA.IDX_HIST2_DATE_ACTION ON HIBA.HIST_RESIDENT(DATE_ACTION);
...
INSERT INTO HIBA.GEST_RESIDENT (ID, NOM, PRENOM, DATENAISS, ADRESSE, TELEPHONE, EMAIL, STATUT,ITUATIONFAMILIALE)
...
INSERT INTO HIBA.GEST_VEHICULE (IMMATRICULATION, MARQUE, MODELE, TYPE, ETAT, SERVICE, DATEMAINTENCE, ID_RESIDENT)
...
INSERT INTO HIBA.GEST_EMPLOYE (ID, NOM, PRENOM, EMAIL, POSTE, SALAIRE, ID_RESIDENT)
...
INSERT INTO HIBA.GEST_CABINET (ID, NOM, ADRESSE, SPECIALITE, TELEPHONE, EMAIL, ID_RESIDENT)
...
INSERT INTO HIBA.GEST_JARDIN (ID_JARDIN, NOM, ADRESSE, SUPERFICIE, TYPE_JARDIN, DATE_CREATION)
...
INSERT INTO HIBA.GEST_MAISON (ID_MAISON, ADRESSE, SUPERFICIE, NOMBRE_PIECES, TYPE_MAISON, PRIX_LOCATION)
...
INSERT INTO HIBA.GEST_RESIDENT_JARDIN (ID_RESIDENT, ID_JARDIN, DATE_ACCES)
...
INSERT INTO HIBA.GEST_RESIDENT_MAISON (ID_RESIDENT, ID_MAISON, DATE_EMMENAGEMENT, STATUT_OCCUPATION)
...
SELECT 'GEST_RESIDENT' AS TABLE_NAME, COUNT(*) AS NB_RECORDS FROM HIBA.GEST_RESIDENT
UNION ALL
SELECT 'GEST_VEHICULE', COUNT(*) FROM HIBA.GEST_VEHICULE
UNION ALL
SELECT 'GEST_EMPLOYE', COUNT(*) FROM HIBA.GEST_EMPLOYE
UNION ALL
SELECT 'GEST_CABINET', COUNT(*) FROM HIBA.GEST_CABINET
UNION ALL
SELECT 'GEST_JARDIN', COUNT(*) FROM HIBA.GEST_JARDIN
UNION ALL
SELECT 'GEST_MAISON', COUNT(*) FROM HIBA.GEST_MAISON
UNION ALL
SELECT 'GEST_RESIDENT_JARDIN', COUNT(*) FROM HIBA.GEST_RESIDENT_JARDIN
UNION ALL
SELECT 'GEST_RESIDENT_MAISON', COUNT(*) FROM HIBA.GEST_RESIDENT_MAISON
UNION ALL
SELECT 'HISTORIQUE_RESIDENT', COUNT(*) FROM HIBA.HISTORIQUE_RESIDENT
UNION ALL
SELECT 'HIST_RESIDENT', COUNT(*) FROM HIBA.HIST_RESIDENT;
