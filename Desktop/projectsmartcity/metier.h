...
public:
    ...
    // - name:path (e.g. jardin1:vd/jardin1.mp4)
    ...
    QStringList cabinetNames() const; // derived names (jardin1, jardin2...) or filename bases

    // Générer une carte de visite professionnelle (image PNG/JPEG)
    // Inclut nom, spécialité, cabinet/jardin, email, téléphone, adresse
...
private:
    ...
    QStringList m_names; // parallel list of jardin/cabinet names
